...
Shatter.prototype.setFunc = function(func1){
        for(i =0; i < this.images.length; i++){
            this.images[i].func = func1;
        }
};
...
Shatter.prototype.spliceImage = function (polygons, img) {
    ...
    polygons.forEach(function (polygon) {
        ...
        tempBigImage.custom = {pol: polygon,img : croppedImage};
        
        tempBigImage.onload = function(){
           
            
            this.custom.img.src = Shatter.prototype.getCroppedImage(this.custom.pol, this);
        }; 
        tempBigImage.src = Shatter.prototype.getClippedImage(polygon, tempCtx, tempCanvas, img);
...
function nothing(mousex,originx,px,mousey,originy,py) {
    return [0,0];
}
